<x-app-layout>
            ...
            <div class="px-5 py-4 border-b border-miga flex items-center gap-3 flex-wrap">
                <form method="GET" class="contents" id="searchForm">
                    ...
                    <div class="hidden sm:flex items-center gap-1.5">
                        ...
                        <button type="button"
                            onclick="setMarginFilter('{{ $filter['param'] }}')"
    ...
    (function () {
        ...
        const topRecipes = @json($topRecipesForChart);
        ...
        const donutData = @json($costDistributionForChart);
    ...
    function setMarginFilter(value) {
        document.getElementById('marginFilterInput').value = value;
