<div x-data="{ open: false }" class="sm:hidden">
    ...
    >
        ...
        <div class="px-4 py-3">
            ...
            <a href="{{ route('production-orders.index') }}" @click="open = false"
                class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors
                    {{ request()->routeIs('production-orders.*') ? 'bg-horno/10 text-horno' : 'text-corteza hover:bg-miga' }}">
        ...
        <div class="px-4 pb-3">
            ...
            @can('edit-settings')
            <a href="{{ route('delivery-people.index') }}" @click="open = false"
                class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors
                    {{ request()->routeIs('delivery-people.*') ? 'bg-horno/10 text-horno' : 'text-corteza hover:bg-miga' }}">
                <svg class="w-5 h-5 shrink-0 opacity-70" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
