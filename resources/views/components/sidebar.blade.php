...
<aside class="hidden sm:flex flex-col w-52 shrink-0 bg-masa-madre min-h-full">
    ...
    <nav class="flex-1 py-3 overflow-y-auto">
        ...
        {{-- Existencias --}}
        <x-sidebar-group title="Existencias" slug="existencias" :active="request()->routeIs('purchases.*', 'suppliers.*', 'stock.*')">
            @include('components.sidebar-item', [
        ...
        <x-sidebar-group title="Administración" slug="administracion" :active="request()->routeIs('business.*', 'team.*', 'locations.*')">
            @can('edit-settings')
                @include('components.sidebar-item', [
