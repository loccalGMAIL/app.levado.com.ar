...
### Girar el comprobante antes de guardarlo
...
- **El prompt de `InvoiceExtractor` (Compras) NO necesita la aclaración de fecha.** Se sospechaba que arrastraba el mismo problema de formato, pero se midió contra la API real con una factura fechada 05/03/2026 (ambigua: 5 de marzo acá, 3 de mayo a la americana) y acertó 5/5. El modelo infiere el formato argentino del contexto del propio prompt, que ya habla de una panadería argentina y de CUIT. No se tocó.
