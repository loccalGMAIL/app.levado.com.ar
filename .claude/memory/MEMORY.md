...
- [Modelo de dominio Insumos vs Artículos](domain-model-articulos.md) — ADR: el Artículo es dueño único de costo (`currentCost()` ✅) y precio (migración pendiente P2); roadmap de centralización
