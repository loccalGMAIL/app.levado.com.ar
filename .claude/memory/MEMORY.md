...
- [Módulo de Compras](feature-compras.md) — Tablas, flujos, servicios, vistas y estado de fases del módulo de compras (act. v0.8.14)
- [Módulo de Existencias](feature-existencias.md) — Ledger inmutable, StockService, integración con compras, edición inline en catálogos (v0.9.0)
