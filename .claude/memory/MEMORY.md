...
- [Artículos + Producción](feature-articulos-produccion.md) — Módulo product-céntrico (rama v0.13.0): Producto=SKU vendible/stockeable, Receta=BOM; pricing repartido (elaborado en receta, reventa en producto); estado por etapas (1a-1c ✅, 2-3 🔲)
