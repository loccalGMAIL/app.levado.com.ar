...
- [Módulo de Compras](feature-compras.md) — Tablas, flujos, servicios, vistas y estado de fases del módulo de compras. Incluye los tres estados del renglón, el cambio de semántica del contador a *resueltos*, la memoria de vinculación por proveedor, el manejo de unidad/precio unitario en la carga y los renglones sin cargo/bonificados (act. v0.12.14)
- [Módulo de Existencias](feature-existencias.md) — Ledger inmutable, StockService, integración con compras, edición inline y orden por columnas (act. v0.12.14, tipo Bonificación)
