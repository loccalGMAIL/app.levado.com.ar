...
- [Modelo de dominio Insumos vs Artículos](domain-model-articulos.md) — ADR: el Artículo es dueño único de **costo** (`currentCost`/`fullCost` ✅) y **precio** (`product_prices` ✅, P2 completo); Receta = BOM; falta P3 (políticas de precio/costeo) y P4 (Producción)
