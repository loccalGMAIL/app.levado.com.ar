...
- [Artículos + Producción](feature-articulos-produccion.md) — Módulo product-céntrico (rama v0.13.0): Producto=SKU vendible/stockeable, Receta=BOM. **Etapas 1–3 + Fase A (matriz de precios dentro de Artículos, listas → Administración) + Fase B (código EAN-13 interno para todos) ✅.** Comandos de deploy `products:backfill-prices`/`assign-codes`. **P4 = reestructurar Producción (próximo, alcance sin definir — ver la nota P4 en el archivo)**
