...
- **P2 🔲**: mover pricing Receta→Artículo (migrar `recipe_prices`; repuntar Dashboard rentabilidad + matriz; retirar
  split `recipe_prices`/`product_prices` — las de reventa ya están latentes). Es el próximo hito grande.
