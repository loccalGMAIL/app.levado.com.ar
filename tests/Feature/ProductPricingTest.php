...
test('el catálogo de Artículos muestra costo, precio y margen del elaborado', function () {
    ...
    // El precio del artículo vive en product_prices (fuente única).
    app(ProductPriceWriter::class)->set($product, $tenant->defaultPriceList(), 25);

    $this->actingAs($user)
        ->get(route('products.index'))
        ->assertOk()
        ->assertSee('FacturasTest')
        ->assertSee('25,00')   // precio del artículo
